...
namespace CRC
{
    public interface ICRC
    {
        ...
        long Crc(byte[] buffer);

        long Crc(byte[] buf, int off, int len);
  ...
  { 
   ...
   116,42,200,150,21,75,169,247,182,232,10,84,215,137,107,53 
        ...
        public long Crc(int bval)
        {
            return CRC8_Table[0 ^ bval];
        }
        ...
        public long Crc(byte[] buf, int off, int len)
        {
            crc = 0;
            if (buf == null)
            {
